...
from models.layers import get_embedding, Linear, MLP
...
class CINModel(torch.nn.Module):
    ...
    """
    def __init__(self, nfield, nfeat, nemb, cin_nlayer, nfilter,
                 emb_nlayer, emb_nhid, emb_ndeep):
        super().__init__()
        self.embedding = get_embedding(nfield, nfeat, nemb, emb_ndeep, emb_nhid, emb_nlayer)
        self.linear = Linear(nfeat)
        self.cin = CompressedInteraction(nfield, cin_nlayer, nfilter)
