import torch
from models.lr import LRModel,MLPModel
...
from models.arm import ARMNetModel0
...
def create_model(args, logger):
    ...
    if args.model == 'lr':
        ...
        model = MLPModel(args.nfeat, args.nlayers, args.nhid, args.dropout,noutput=1)
    ...
    elif args.model == 'arm0':
        model = ARMNetModel0(args.nfield, args.nfeat, args.nemb, args.nattn_head, args.alpha, args.h,
